...
<form enctype="multipart/form-data" action="index.php?r=pgoods/uppginfo&pag=<?php echo $pag; ?>" method="post" >
	<!--新添加的-->
	<ul style="width: 675px;height: auto;margin-left: 70px;margin-top: 28px;">
		...
		<li style="width: 100%;height:52px ;color: #5a5a5a;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
  				 <input id="kw" autocomplete="off" name="Doctor[hospitalname]" value="<?php echo $hosName[0]['hospitalName']?>" onKeyup="getContent(this);" style="width:527px;height: 38px;outline: none;border: 0;border: 1px solid #CDCDCD;-moz-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;text-indent: 25px;" class="form-control" id="exampleInputEmail1" required="required"/>
  				 <span style="color:#ff9191;font-size: 13px;">不能手动全部输入，请点击，下面输入框的提示医院</span>
  				 <input id="haha" type="hidden" name="hisHospid" value="<?php echo $hosName[0]['id']?>" />
  				 <input type="hidden" name="gid" value="<?php echo $pgArr['id']; ?>" />
  			...
  			<div class="form-group" >
                <label for="exampleInputEmail1"><span ><?php echo $hosName[0]['hospitalName'];?></span></label>        		
        		<input type="hidden" name="hisHospid" value="<?php echo $hosName[0]['id'];?>"/>
				<input type="hidden" name="gid" value="<?php echo $pgArr['id']; ?>" />
			</div>	
			<?php }?>
  		</li>
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
  				 <input name="proName" value="<?php echo $pgArr['proName']; ?>" style="width:527px;height: 38px;outline: none;border: 0;border: 1px solid #CDCDCD;-moz-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;text-indent: 25px;"  required="required" placeholder="填写服务类别，如：玻尿酸、韩式双眼皮或自体脂肪丰胸等" onfocus="this.placeholder=''" onblur="this.placeholder='填写服务类别，如：玻尿酸、韩式双眼皮或自体脂肪丰胸等'" />
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
  				 <input name="proIntro" value="<?php echo $pgArr['proIntro']; ?>" style="width:527px;height: 38px;outline: none;border: 0;border: 1px solid #CDCDCD;-moz-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;text-indent: 25px;"  required="required" placeholder="形容服务项目，用于包装产品的名字，如：侧脸女王，高挺美鼻不是梦" onfocus="this.placeholder=''" onblur="this.placeholder='填写服务类别，如：玻尿酸、韩式双眼皮或自体脂肪丰胸等'"/>
  				 <span style="color: #ff9191;font-size: 13px;">(只填文字，请不要添加【】)</span>
  			</div>
  		</li>
  		<!--项目类型-->
  		<li style="width: 100%;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;min-height:60px ;height: auto!important;height: 60px;float: left;position: relative;">
  				<div style="width:438px;min-height: 38px;height: auto!important;height: 38px;outline: none;border: 0;border: 1px solid #CDCDCD;-moz-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;display: inline-block;" class="listBox">
      				...
      				<!-- <div style="display: inline-block;margin-right: 15px;font-size: 13px;">
          				<input type="hidden" name="M[selected][mbuy1]" value="47">
          				<p style="display: inline-block;">眼部修复</p>
          				<img src="../assets/common/img/applicantDoctor-images/quxiao.png" style="width: 15px;height: 15px;margin-left: 6px;margin-top:-3px;" class="img-delete">
      				</div>   -->  
      				<?php if(!empty($sm)){  ?>
      					<?php foreach($sm as $k=>$v){   ?>
      					 <div style="display: inline-block;margin-right: 15px;font-size: 13px;">
          				    <input type="hidden" name="M[selected][mbuy<?=$k; ?>]" value="<?=$v['id']; ?>">
          				    <p style="display: inline-block;"><?=$v['mName']; ?></p>
          				    <img src="../assets/common/img/applicantDoctor-images/quxiao.png" style="width: 15px;height: 15px;margin-left: 6px;margin-top:-3px;" class="img-delete">
          				 </div>         				            				      				
      				<?php } }   ?>
      				</div>
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
  				<select id='Fstyle1' name='docId' style="width:82px;height: 34px;background: #FFFFFF!important;">
          			 <?php if(!empty($dgArr)){ ?>
                           <?php foreach($listdocName as $v){?>
                                   <?php if($dgArr['docId'] == $v['Id']){?>
                                   		<option value="<?php echo $v['Id']?>" selected><?php echo $v['docName']?></option>                  
                               	   <?php }else{?>
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
		  		...
		  		<select id="city" name="city" style="width:82px;height: 34px;background: #FFFFFF!important;margin-left: 14px;" class="">
          			...
          			<?php foreach($cityArr as $v){?>
              			<?php if($v['id'] == $pgArr['proSite']){?>
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
  				<span><?php echo $cityArr[0]['name']; ?></span>	
        		<input type="hidden" name="city" value="<?php echo $pgArr['proSite']; ?>" />	          
  			</div>
  		</li>
		<?php }?> 
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
			    <input required="required" name="starttime" value="<?php echo $pgArr['onshelfTime']; ?>" class="laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" style="height:36px;">	             
  			</div>
  		</li>
  		<!--下架时间-->
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
			          <input required="required" name="endtime" value="<?php echo $pgArr['offshelfTime']; ?>" class="laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" style="height:36px;">
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
			     <input required="required" name="valitime" value="<?php echo $pgArr['validateTime']; ?>" class="laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" style="height:36px;">
  		...
  		<li style="width: 100%;height:60px ;color: #5a5a5a;margin-top: 20px;">
  			...
  			<div style="width: 527px;height:60px ;float: left;">
			    <input name="lowPrice" value="<?php echo $pgArr['lowPrice']; ?>" style="width:176px;height: 38px;outline: none;border: 0;border: 1px solid #CDCDCD;-moz-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px;text-indent: 25px;"  required="required"/>
  		...
  		<li style="width: 1090px;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;margin-left: -73px;margin-bottom: 96px;">
  			<table id="table" border="1px" width="87%"    align="center">
		            ...
		            <?php foreach ($gdskuArr as $k=>$v) {?>
                        <tr align="center">
                        	<td>
                            	<input type="hidden" name="skuShu" value="<?php echo $skuct ?>" />
                            	<input type="hidden" name="gdId<?php echo $k;?>" value="<?php echo $v['id']; ?>" />
                            	<input type="hidden" name="skuTypeId<?php echo $k;?>" value="<?php echo $v['skuTypeId']; ?>" />
                            	<input type="text" name="skuName<?php echo $k;?>" value="<?php echo $v['name']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>
                        	<td height="50px" width="170px">
                        		<input type="text" name="skuSpecification<?php echo $k;?>" value="<?php echo $v['specification']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>                       	
                        	<td height="50px" width="170px">
                        		<input type="text" name="gdPrice<?php echo $k;?>" value="<?php echo $v['price']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>
                        	<td  width="170px">
                        		<input type="text" name="gdSetPrice<?php echo $k;?>" value="<?php echo $v['setPrice']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>
                        	<td  width="170px">
                        		<input type="text" name="gdHosPrice<?php echo $k;?>" value="<?php echo $v['hosPrice']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>
                        	<td width="170px">
                        		<input type="text" name="gdNum<?php echo $k;?>" value="<?php echo $v['num']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>
                        	<td width="170px">
                        		<input type="text" name="gBuyLimit<?php echo $k;?>" value="<?php echo $v['buyLimit']; ?>" style="border:0;height:43px;background:#f7f7f7;" />
                        	</td>                	              
                        </tr>
            		<?php }?>
    		</table>
  	...
  	<ul style="width: 675px;height: auto;margin-left: 70px;margin-top: 28px;">
  		...
  		<li style="width: 100%;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;display: inline-block;">
  			...
  			<div style="width: 527px;min-height:60px ;height: auto!important;height: 60px;float: left;">
	  				 	<div style="width: 100%;height:20px;">原图为：</div>  
	  				 	<div style="width: 800px;min-height:8px ;height: auto!important;height: 8px;" >      			
                  			<?php if(!empty($pgArr['proImage'])){?><img src=<?=$pgArr['proImage']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['carouselImage2'])){?><img src=<?=$pgArr['carouselImage2']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['carouselImage3'])){?><img src=<?=$pgArr['carouselImage3']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['carouselImage4'])){?><img src=<?=$pgArr['carouselImage4']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  		</div>
      					<div style="width: 100%;height:20px;">修改为：</div>
  		...
  		<li style="width: 100%;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;display: inline-block;">
  			...
  			<div style="width: 527px;min-height:60px ;height: auto!important;height: 60px;float: left;">
  						<div style="width: 100%;height:20px;">原图为：</div>  
	  				 	<div style="width: 800px;min-height:8px ;height: auto!important;height: 8px;" >      			
                  			<?php if(!empty($pgArr['proImage2'])){?><img src=<?=$pgArr['proImage2']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage4'])){?><img src=<?=$pgArr['proImage4']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage5'])){?><img src=<?=$pgArr['proImage5']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage6'])){?><img src=<?=$pgArr['proImage6']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  		</div>
      					<div style="width: 100%;height:20px;">修改为：</div>
				    	...
				    	<textarea name="proDesc2" style="width:527px ;height: 114px;margin-top: 8px;resize: none;"><?php echo $pgArr['proDesc2']; ?></textarea>	
  			</div>
  		</li>
  		...
  		<li style="width: 100%;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;display: inline-block;">
  			...
  			<div style="width: 527px;min-height:60px ;height: auto!important;height: 60px;float: left;">
  						<div style="width: 100%;height:20px;">原图为：</div>  
	  				 	<div style="width: 800px;min-height:8px ;height: auto!important;height: 8px;" >      			
                  			<?php if(!empty($pgArr['proImage3'])){?><img src=<?=$pgArr['proImage3']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage7'])){?><img src=<?=$pgArr['proImage7']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage8'])){?><img src=<?=$pgArr['proImage8']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['proImage9'])){?><img src=<?=$pgArr['proImage9']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  		</div>
      					<div style="width: 100%;height:20px;">修改为：</div>
				    	...
				    	<textarea name="proDesc3" style="width:527px ;height: 114px;margin-top: 8px;resize: none;"><?php echo $pgArr['proDesc3']; ?></textarea>	
  			</div>
  		</li>
  		<!--产品详情图3-->
  		<li style="width: 100%;min-height:60px ;height: auto!important;height: 60px;color: #5a5a5a;margin-top: 20px;display: inline-block;">
  			...
  			<div style="width: 527px;min-height:60px ;height: auto!important;height: 60px;float: left;">
  						<div style="width: 100%;height:20px;">原图为：</div>  
	  				 	<div style="width: 800px;min-height:8px ;height: auto!important;height: 8px;" >      			
                  			<?php if(!empty($pgArr['effectDrawing'])){?><img src=<?=$pgArr['effectDrawing']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['effectDrawing2'])){?><img src=<?=$pgArr['effectDrawing2']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['effectDrawing3'])){?><img src=<?=$pgArr['effectDrawing3']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  			<?php if(!empty($pgArr['effectDrawing4'])){?><img src=<?=$pgArr['effectDrawing4']?>  style="width:150px;height:150px;padding-left:6px;margin-bottom:12px;" /><?php }?>
                  		</div>
      					<div style="width: 100%;height:20px;">修改为：</div>  			
				    	...
				    	<textarea name="proDesc4" style="width:527px ;height: 114px;margin-top: 8px;resize: none;"><?php echo $pgArr['proDesc4']; ?></textarea>	
  			</div>
  		</li>
  		<!--返回 提交-->
...
<script type="text/javascript">
    ...
    $('#goodbutton').unbind().bind('click', function (){
        ...
        tables += '<tr align="center"><td><input type="hidden" name="new_skuShu" value="'+shu+'" /><input type="text" name="sku[skuName][skuName'+shu+']" style="border:0;height:43px;background:#f7f7f7;"></td>';
        ...
        tables += '<td width="170px" text-align="center"><input type="text" name="sku[gBuyLimit][gBuyLimit'+shu+']" value="1" style="border:0;height:43px;background:#f7f7f7;"></td>';
